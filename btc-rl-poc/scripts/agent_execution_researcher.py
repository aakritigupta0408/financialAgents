...
def main():
    age = fw.stale("a3v21_window_evaluation.jsonl", 3600)
    if age is not None:
        ...
        return
    p = RES / "a3v21_window_evaluation.jsonl"
    rows = []
    if p.exists():
        for l in p.open():
            if l.strip():
    ...
    doc = {
        ...
        "provenance": ["a3v21_window_evaluation.jsonl"],
    }
