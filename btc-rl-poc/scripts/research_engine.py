...
JOBS = [
    ...
    {"id": "test_v2_power", "lane": "L9", "priority": 0,
     "title": "TEST_V2 power analysis — pre-register target N (DEV-only, V2 unseen)",
     "cmd": ["python3", "scripts/test_v2_power_analysis.py"],
     "deps": ["offline_program"], "artifact": "test_v2_power_analysis"},
    {"id": "test_v2_audit", "lane": "L9", "priority": 0,
     ...
     "deps": ["settled_refetch", "test_v2_power"], "artifact": "test_v2_capture_audit"},
